...
This experiment was created using PsychoPy3 Experiment Builder (v2021.1.3),
    on Thu 06 May 2021 05:02:36 AM EEST
...
expName = 'objectNaming'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/home/dude/Documents/psychological_tests/Object Naming/objectNaming.py',
...
for thisTrial in trials:
    ...
    # update component parameters for each repeat
    if trials.thisN == 0 or trials.thisN % 240 != 0:
        continueRoutine = False
    # keep track of which components have finished
